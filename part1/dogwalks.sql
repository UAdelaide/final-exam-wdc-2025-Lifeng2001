...
((SELECT dog_id FROM Dogs WHERE name = 'Tmood'),'2025-06-10 12:00:00',30,'Torrens Ave', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Stake'),'2025-06-10 14:00:00',50,'Torren Ave', 'open'),
